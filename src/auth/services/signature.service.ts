...
/**
 * SignatureService
 * Handles Web3 wallet signature generation and verification
 * Uses ethers.js for Ethereum signature operations
 */
@Injectable()
export class SignatureService {
  ...
  generateMessage(nonce: string): string {
    return SIGNATURE_MESSAGE_TEMPLATE.replace('{nonce}', nonce).replace(
      '{timestamp}',
